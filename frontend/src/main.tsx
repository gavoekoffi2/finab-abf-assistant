...
const initialForm: FormState = {
  legalLastName: 'TUSEWU NZAZI',
  firstNames: 'Jocelina',
  dateOfBirth: '1995-05-17',
  phone: '5147710947',
  email: 'jocelina@example.com',
  address: '9580 rue Berri',
  city: 'Montréal',
  province: 'QC',
  postalCode: 'H2M 1R4',
  occupation: 'Congé de maternité / PAB',
  employerName: '',
  annualIncome: '34000',
  ...
  acceptableBudget: '100',
  dependents: '2',
  maritalStatus: 'monoparental',
  residencyStatus: 'Personne protégée',
  placeOfBirth: 'Angola',
  priorityProjects: 'Protéger ses enfants et commencer avec un budget réaliste.',
  familyNeed: 'Protéger les enfants en cas de décès prématuré.',
};
